                ...
                foreach ($data_event as $data) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-md btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" href="<?= base_url(); ?>admin_controller/delete_event/<?= $data->id_events; ?>">Hapus</a>
                        </td>
                    </tr>
                <?php  } ?>
            </tbody>
